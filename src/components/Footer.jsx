                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '2rem' }}>
                    ...
                    <div>
                        ...
                        <div style={{ display: 'flex', gap: '1.5rem', marginTop: '1.5rem' }}>
                            <a href="https://youtube.com/@genfree" target="_blank" rel="noopener noreferrer" style={{ color: '#94a3b8', transition: 'color 0.2s' }} onMouseOver={(e) => e.target.style.color = '#FF0000'} onMouseOut={(e) => e.target.style.color = '#94a3b8'}><Youtube size={24} /></a>
                            <a href="https://facebook.com/genfree" target="_blank" rel="noopener noreferrer" style={{ color: '#94a3b8', transition: 'color 0.2s' }} onMouseOver={(e) => e.target.style.color = '#1877F2'} onMouseOut={(e) => e.target.style.color = '#94a3b8'}><Facebook size={24} /></a>
                            <a href="https://instagram.com/genfree" target="_blank" rel="noopener noreferrer" style={{ color: '#94a3b8', transition: 'color 0.2s' }} onMouseOver={(e) => e.target.style.color = '#E4405F'} onMouseOut={(e) => e.target.style.color = '#94a3b8'}><Instagram size={24} /></a>
                            <a href="https://tiktok.com/@genfree" target="_blank" rel="noopener noreferrer" style={{ color: '#94a3b8', transition: 'color 0.2s' }} onMouseOver={(e) => e.target.style.color = '#000000'} onMouseOut={(e) => e.target.style.color = '#94a3b8'}>
